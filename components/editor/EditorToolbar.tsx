...
function smallBtnProps() {
  return "inline-flex h-8 w-8 items-center justify-center rounded text-sm hover:bg-muted/50"
}
...
export function EditorToolbar(props: EditorToolbarProps) {
  ...
  return (
    <div className="w-full border-b bg-white">
      ...
      {/* Format toolbar */}
      <div className="flex w-full items-center gap-2 overflow-x-auto px-3 py-3">
